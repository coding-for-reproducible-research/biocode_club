...
- Each script should:
    - Be runnable from beginning to end as a complete R script without manual intervention (i.e. don’t rely on highlighting lines within RStudio and running these separately).
    - Be easy to read, using descriptive variable names and including comments where helpful to understand what’s going on.
