...
3.	What to store under version control?

4.	How to start a new workflow using a standard structure
...
5.	How to adapt your existing code into a standard structure
...
6.	Maintaining healthy pipelines
...
A well-structured workflow that follows a standardised structure helps to address these issues.
Using a well-structured workflow:
...
* Saves the developer time in the long run, because it’s easier to find things and make changes.
Using a standardised workflow structure:
